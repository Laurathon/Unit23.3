...
# Add users
laura = User(first_name='laura', last_name='Smith', image_url='http://joelburton.com/joel-burton.jpg')
chuck = User(first_name='chuck', last_name='Smith', image_url='http://joelburton.com/joel-burton.jpg')
mary = User(first_name='mary', last_name='Finley', image_url='http://joelburton.com/joel-burton.jpg')
donald = User(first_name='donald', last_name='Duck', image_url='http://joelburton.com/joel-burton.jpg')

cheeses = Post(title='Cheese',content='Cheddar, Brie, Mozzarella')
birds = Post(title='Birds',content='Parakeet, Robin, Tufted Titmouse')
exercise = Post(title='Exercise',content='Run, Bike, Swim')
books = Post(title='Books',content='Pride and Predjudice, The Shack, Art of War')


db.session.add_all([laura, chuck, mary, donald])
db.session.commit()
